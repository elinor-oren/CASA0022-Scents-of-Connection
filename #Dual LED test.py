...
def apply_gradient_effect_headset1(meditation):
    ...
    if meditation <= 25:
        ...
        for i in range(27, 30):
            new_state1[i - 22] = gradient_color(start_color, end_color, i - 27, 3)
    elif meditation <= 60:
        for i in range(22, 30):
            new_state1[i - 22] = start_color
        for i in range(31, 34):
            new_state1[i - 22] = gradient_color(start_color, end_color, i - 31, 3)

    elif meditation <= 80:
        for i in range(22, 34):
            new_state1[i - 22] = start_color
        for i in range(35, 38):
            new_state1[i - 22] = gradient_color(start_color, end_color, i - 35, 3)
    else:
        for i in range(22, 38):
            new_state1[i - 22] = start_color
        for i in range(39, 41):
            new_state1[i - 22] = gradient_color(start_color, end_color, i - 39, 2)
