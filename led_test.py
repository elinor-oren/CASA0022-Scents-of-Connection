...
LED_ORDER = neopixel.GRB  # Pixel color channel order, change to RGBW if needed
...
def set_leds(meditation_level, headset_id):
    ...
    if headset_id == 1:
        ...
        color = (255, 0, 0)  # Red
        start_index = LED_COUNT - 10
        for i in range(start_index, start_index + min(10, led_count)):
            strip[i] = color
